...
fun TasksScreen(tasksViewModel: TasksViewModel) {
    ...
    val lifecicle = LocalLifecycleOwner.current.lifecycle
    ...
    val uiState by produceState<TaskUiState>(
        ...
        lifecicle.repeatOnLifecycle(state = Lifecycle.State.STARTED) {
    ...
    when (uiState) {
        ...
        is TaskUiState.Success -> {
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                TaskList((uiState as TaskUiState.Success).task, tasksViewModel)
            }
        }
    }
}
...
fun ItemTask(taskModel: TaskModel, tasksViewModel: TasksViewModel) {
    Card(
        ...
        Row(
            ...
            Checkbox(checked = taskModel.isCompleted, onCheckedChange = {
